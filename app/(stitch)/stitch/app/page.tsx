...
const navItems = [
  { icon: "dashboard", label: "ראשי", active: true },
  { icon: "assignment", label: "משימות", active: false },
  { icon: "chat_bubble", label: "צ'אט", active: false },
  { icon: "person", label: "פרופיל", active: false },
];
...
export default function StitchAppPage() {
  return (
    <div
      className="relative flex min-h-screen w-full flex-col overflow-hidden md:max-w-md md:mx-auto md:border-x md:border-gray-100 no-scrollbar bg-gray-50/50"
      dir="rtl"
      lang="he"
    >
      ...
      {/* Bottom navigation */}
      <nav className="fixed bottom-0 left-0 w-full md:max-w-md md:left-auto bg-white border-t border-gray-100 px-6 py-3 pb-6 z-30 flex justify-between items-center text-xs font-medium text-gray-400">

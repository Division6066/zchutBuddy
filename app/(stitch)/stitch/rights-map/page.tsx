...
/**
 * Stitch Rights Map Results Page Preview
...
export default function StitchRightsMapPage() {
  return (
    <div
      className="relative flex min-h-screen w-full flex-col overflow-y-auto overflow-x-hidden md:max-w-md md:mx-auto md:border-x md:border-gray-100 no-scrollbar bg-slate-50"
      dir="rtl"
      lang="he"
    >
      {/* Header */}
      ...
      {/* Main content */}
      <main className="flex-1 flex flex-col p-5 gap-4 pb-24">
        {rights.map((right) => (
          <div
            key={right.title}

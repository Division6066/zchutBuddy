...
export default function StitchPricingPage() {
  return (
    ...
    >
      ...
      {/* Header */}
      <header className="flex items-center justify-between p-6 pt-8 z-10 sticky top-0 bg-white/80 backdrop-blur-md border-b border-gray-100/50">
        <Link
          href="/stitch/home"
      ...
      {/* Main content */}
      <main className="flex-1 flex flex-col px-6 pb-24 relative z-10 w-full overflow-y-auto">
        {/* Intro */}

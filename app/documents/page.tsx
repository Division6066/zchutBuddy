...
/**
 * Documents Generator Page
 * Based on Stitch design: welcome_to_zchuyotbuddy_7
 */
export default function DocumentsPage() {
  return (
    ...
    >
      ...
      {/* Header */}
      <header className="flex items-center justify-between p-6 pt-12 z-20 max-w-4xl mx-auto w-full">
      ...
      {/* Main content */}
      <main className="flex-1 overflow-y-auto px-6 pb-32 z-10 no-scrollbar max-w-4xl mx-auto w-full">
        {/* Title */}
      ...
      {/* Fixed CTA */}
      <div className="fixed bottom-0 left-0 right-0 p-6 bg-white/80 backdrop-blur-xl border-t border-gray-100 z-20">
